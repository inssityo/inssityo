<template>
  <div class="flexbox" v-bind:class="{'padding': idValue === 'A'}">  
    <label v-show="aptValue === 'R'" for="monthlyRent" class="label__border-bottom--green border-radius__left">Vuokra</label>
    <input v-show="aptValue ==='R'" type="text" id="monthlyRent" class="border-radius__right" v-model="monthlyRent" v-on:keyup="emitToParent">
    <label v-show="aptValue === 'R'" for="monthlyRent" id="euroLabel" >€/kk</label>
    <div class="flexbox" v-show="aptValue === 'B'" id="saleDiv">
    ...
    <input  type="text" id="debt-free" class="border-radius__right" v-model="debtFreePrice" v-on:keyup="emitToParent">
  ...
  <input type="number" step="0.01" id="upkeep" class="border-bottom--green" v-model="upkeep" v-on:input="emitToParent">
  ...
  <input type="number" step="0.01" id="financing" class="border-bottom--green" v-model="financing" v-on:input="emitToParent">
